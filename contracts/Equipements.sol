...
contract Equipements is ERC721, ERC721Enumerable, ERC721URIStorage, ERC721Burnable, Pausable, Ownable {
    ...
    function NFTMintById(address _to, uint256 tokenId) public {
        ...
        require(tokenId <= 50+maxSupply, "Max supply reached");
        require(tokenId > 50, "Id starts at 51");
